...
| fullnameOverride | string | `""` | fullnameOverride: String to fully override `"armada-backup.fullname"` |
...
| serviceAccount.name | string | `""` | name: ServiceAccount name override, default: `"armada-backup.fullname"` |
